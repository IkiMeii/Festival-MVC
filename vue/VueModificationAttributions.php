...
<table width='80%' cellpadding='0' cellspacing='0' align='center'>
   <tr>
      <td align='center'><a href='./?action=accueil'>Accueil > </a><a href='./?action=attribution'>Consultation Attributions > <a href='./?action=ModAtt'>Modification Attributions</td>
   </tr>
</table>
...
<table width='80%' cellspacing='0' cellpadding='0' align='center' class='tabQuadrille'>
   ...
   ?><tr class='ligneTabQuad'>
         ...
         ?><td class='reserve'>
                  <a href='./?action=DonNbCham' href='?idEtab=<?= $idEtab ?>&amp;idGroupe=<?= $idGroupe ?>&amp;nbChambres=<?= $nbMax ?>'>
                     <?= $nbOccupGroupe ?></a>
               </td>
               ...
               ?><td class='reserveSiLien'>
                     <a href='./?action=DonNbCham' href='?idEtab=<?= $idEtab ?>&amp;idGroupe=<?= $idGroupe ?>&amp;nbChambres=<?= $nbChLib ?>'>
                        __</a>
                  </td>
...
<table align='center' width='80%'>
   <tr>
      <td width='34%' align='left'><a href='./?action=attribution'>Retour</a>
      </td>
      <td class='reserveSiLien'>&nbsp;</td>
